...
#define LEN_ARRAY 3 //ajustar el len de los arrays de string si se desea tener mayor espacio.
#endif /* UTN_H_ */
/*
 * \brief crea las opciones de un menu
 * \param mensaje mensaje de las opciones
 * \param mensajeError mensaje de error
 * \param min valor minimo de opcion
 * \param max valor amximo de opcion
 * \param reintentos valor de reintentos
 *
 * */
